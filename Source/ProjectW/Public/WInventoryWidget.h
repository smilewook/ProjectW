...
class PROJECTW_API UWInventoryWidget : public UWContentWidgetBase
{
	...
	/* Methods */
public:
	virtual bool InitWidget(UWMainWidget* pMainWidget, UWContentManagerBase* pContentManager) override;

	bool CreateSlot(FInventorySlotInfo* pSlotInfo, int row, int column);
